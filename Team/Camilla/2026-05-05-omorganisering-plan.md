...
→ Alle → `Min Inbox/projects/vidensapp/`

**Team Inbox/ (3 filer)**:
- 1 Mads CISO-mandat
- 1 Poul svar på spørgsmål
- 1 vidensapp-evernote-style
→ Alle → `Team Inbox/projects/vidensapp/`

**Team/Poul/ (9 vidensapp-relevante filer)**:
- 6 vidensapp-analyse + arkitektur (v3 master + PDF + Excalidraw + NOTE)
- 2 andre-sikkerhed-analyser (secrets-FIPS, YubiHSM)
- 1 vercel-undersøgelse
- +1 udvidelser-vurdering

**Beslutning for Pouls output**: **BEVARES i Team/Poul/** (fordi Poul er fast rolle, crosscutting). Filnavnene får ikke project-tag — git-historik + CLAUDE.md vil dokumentere at de udspringer af vidensapp-behovet.

**Team/Camilla/, Team/Laila/, Team/Mads/** — bevares uden ændring (faste roller).

**arkiv/ (3 filer)**:
- v1, v2 vidensapp-analyser fra Poul
- v1 vidensapp-analyse fra Min Inbox
→ Flytter til `arkiv/projects/vidensapp/` med samme sti-spejling
...
arkiv/Min Inbox/2026-05-05-vidensapp-pouls-analyse.md
  → arkiv/projects/vidensapp/Min Inbox/

arkiv/Team/Poul/2026-05-05-vidensapp-analyse-*.md (2 filer)
  → arkiv/projects/vidensapp/Team/Poul/
```

**Vidensapp-filer i Team/Poul/** forbliver på plads (fast rolle-mappe).

## Interne links der skal opdateres

**Primære kilder**:
1. `Team/Poul/2026-05-05-vidensapp-analyse-v3.md` — hovedanalyse, refs til andre filer
...
```
mkdir -p "Min Inbox/projects/vidensapp"
mkdir -p "Team Inbox/projects/vidensapp"
mkdir -p "arkiv/projects/vidensapp/Min Inbox"
mkdir -p "arkiv/projects/vidensapp/Team/Poul"
```
